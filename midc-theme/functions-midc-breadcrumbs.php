...
function custom_breadcrumbs()
{
    ...
    if (!is_front_page()) {
        ...
        if (is_archive() && !is_tax() && !is_category() && !is_tag()) {
            ...
            // If it is a custom post type display name and link
            if ($post_type != 'post' && $post_type != 'concert') {
                $post_type_object = get_post_type_object($post_type);
                $post_type_archive = get_post_type_archive_link($post_type);
            ...
            echo '<li class="active">' . $get_term_name . '</li>';
        } elseif (is_day()) {
            ...
            // Day display
            echo '<li class="active"> ' . get_the_time('jS') . ' ' . get_the_time('M') . ' Archives</li>';
        } elseif (is_month()) {
            ...
            // Month display
            echo '<li class="active">' . get_the_time('M') . ' Archives</li>';
        } elseif (is_year()) {
               
            // Display year archive
            echo '<li class="active">' . get_the_time('Y') . ' Archives</li>';
        } elseif (is_author()) {
            ...
            // Display author name
            echo '<li class="active">' . 'Author: ' . $userdata->display_name . '</li>';
        } elseif (get_query_var('paged')) {
               
            // Paginated archives
            echo '<li class="active">'.__('Page') . ' ' . get_query_var('paged') . '</li>';
        } elseif (is_search()) {
