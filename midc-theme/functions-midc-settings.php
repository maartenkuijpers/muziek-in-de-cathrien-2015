...
function plugin_admin_init()
{
    ...
    add_settings_field('midc_option_prijs_cjp', 'CJP/student/jongere:', 'midc_option_prijs_cjp', 'midc_options', 'midc_options_prijs');
    add_settings_field('midc_option_prijs_kinderen', 'Kinderen t/m 12 jaar:', 'midc_option_prijs_kinderen', 'midc_options', 'midc_options_prijs');
