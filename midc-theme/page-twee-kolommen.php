 ...
 */
 ...
 switch ($type) {
	case 'text50-text50': $left = 6; $right = 6; break;
 	...
 	case 'picture33-text66': $left = 4; $right = 8; $pictureLeft = true; break;
 	case 'picture66-text33': $left = 8; $right = 4; $pictureLeft = true; break;
...
?><small><?php echo(midc_get_sub_title(get_the_title()));
?></small></h2>
            </div>
